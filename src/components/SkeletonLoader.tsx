  ...
  if (type === 'grid') {
    return (
      <div
        ...
        className="grid animate-pulse grid-cols-1 gap-4 bg-white md:grid-cols-5"
      >
        {[...Array(count)].map((_) => (
          <div
            key={uuidv4()}
            data-testid="grid"
            className={cn('w-full rounded bg-gray-300', className)}
          />
        ))}
      </div>
    );
  ...
  if (type === 'block') {
    return (
      <div
        ...
        className="grid animate-pulse grid-cols-1"
      >
        {[...Array(count)].map((_) => (
          <div
            key={uuidv4()}
